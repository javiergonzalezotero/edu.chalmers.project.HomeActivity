...
public class HomeActivity extends MapActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setSelectedNavigationItem(tabPosition); // To start the activity in different tabs
	}


	/**
	 * Callback activated when we tap the image button of friends in the profile fragment.
	 * It simply starts the friends activity.
	 * @param view
	 */
	...
	/**
	 * Callback activated when we tap the search button in the search fragment. Search in the
	 * database the players that match with the text given and show them in an interactive list
	 * @param view
	 */
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home: //we go to the home fragment
			bundle = this.getIntent().getExtras();
		...
		case R.id.menu_add_new_event: //Add event in home fragment
			...
			intent.putExtras(b2);
			intent.putExtra("idMatch", -1); // no idMatch yet
			startActivity(intent);
			return true;
		...
		case R.id.menu_remove_friend:
			...
			return true;
		case R.id.menu_logout: // logging out and go to the first screen
	...
	/*
	 * Method created in order to let the different fragments to know the matchlist selected
	 */
	...
	/*
	 * Method created in order to let the different fragments to set the matchlist 
	 */
